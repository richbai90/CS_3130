...
bloodTypeVector = c(rep("A", 5), rep("B", 5), rep("A",5), rep("O", 5))
...
cooperIndices = endsWith(heightData$names, "Cooper")
cooperIndices
```
...
```{r}
#heightData$heights[cooperIndices] = heightData$heights[cooperIndices] + 1
heightData
```
